...
\only<2>{
  ...
  \node[body] at (1.3,18.0) {2. Were it certain to land, I would\\explore \ExtraCertainMinutes\ minutes longer.};
}
\only<3>{
  \node[anchor=north west,inner sep=0pt] at (.8,5.4)
    {\includegraphics[width=16.4cm]{ct-lt-carousel-risk-3.pdf}};
  \node[body] at (1.3,18.0) {3. Those hours are worth about\\\RiskSurplusMinutes\ minutes of current research.};
...
\node[title] at (1.3,2.0) {Believing it useless\\costs even more.};
\only<1>{
  \node[anchor=north west,inner sep=0pt] at (.8,5.4)
